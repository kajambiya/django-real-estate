# Generated by Django 3.2.7 on 2021-12-12 11:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(always_update=True, editable=False, populate_from=models.CharField(max_length=250, verbose_name='Property Title'), unique=True)),
                ('ref_code', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Property Reference Code')),
                ('description', models.TextField(default='Enter Property description', verbose_name='Description')),
                ('country', django_countries.fields.CountryField(default='KE', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Uganda', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='2760', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Port Bell Road 15', max_length=150, verbose_name='Street Address')),
                ...
                ('bathrooms', models.IntegerField(default=1, verbose_name='Number of Bathrooms')),
                ('advert_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Rent'), ('For Auction', 'For Auction')], default='For Sale', max_length=50, verbose_name='Advert Type')),
                ...
                ('published_status', models.BooleanField(default=False, verbose_name='Property Published?')),
