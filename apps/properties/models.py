...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(
        ...
        default='Enter Property description'
    )
    ...
    bathrooms = models.IntegerField(verbose_name=_('Number of Bathrooms'),
                                    default=1)
    advert_type = models.CharField(verbose_name=_('Advert Type'),
                                   max_length=50,
                                   choices=AdvertType.choices,
                                   default=AdvertType.FOR_SALE
                                   )
    property_type = models.CharField(verbose_name=_('Property Type'),
                                     max_length=50,
    ...
    photo1 = models.ImageField(
        default='/interior_sample.jpg', null=True, blank=True
    )
    ...
    published_status = models.BooleanField(verbose_name=_('Property Published?'), default=False)
