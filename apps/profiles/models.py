...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+256793452383"
    )
    ...
    is_buyer = models.BooleanField(
        ...
        default=False,
        help_text=_("Are you intending to buy a property?"),
    )
    is_seller = models.BooleanField(
        verbose_name=_("Seller"),
        default=False,
        help_text=_("Are you intending to sell a property?"),
    )
